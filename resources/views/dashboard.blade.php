                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Novas</a></li>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{count($messages)}}</span></h4>
                ...
                <div class="col-md-6 col-xl-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{count($news)}}</span></h4>
