...
<body>
	...
	<section class="cabinet">
		<div class="container">
			<h2 class="cabinet__name section__title">
				Salimjon Komiljonov
			</h2>
				...
				<div class="cabinet-tabs">
					<div class="cabinet-tab">
						<div class="cabinet-form">
							<div class="cabinet-tab__title">
								Ваша информация
							</div>
							<form action="#" class="form">
								<div class="feedback-date">
									<select id="dobday-cabinet"></select>
									<select id="dobmonth-cabinet"></select>
									<select id="dobyear-cabinet"></select>
								</div>
								<div class="form-half">
									<input type="text" placeholder="Имя">
									<input type="text" placeholder="Фамилия">
						...
						<div class="cabinet-form">
							...
							<form action="#" class="form">
								...
								<div class="form-half">
									<input type="password" placeholder="Новый пароль (минимум 8 символов)">
									<input type="password" placeholder="Подтвердите пароль">
								</div>
								<button type="submit" class="btn">Сохранить</button>
							</form>
					...
					<div class="cabinet-tab">
						...
						<div class="cabinet-orders">
							<div class="cabinet-order">
								...
								<div class="cabinet-order__wrap">
									<div>
										<div class="cabinet-order__name">
											Негазированная <span>(1.5)</span>
										</div>
										<div class="cabinet-order__price">
											2 x 9000 <span>UZS</span>
										</div>
									</div>
									<div>
										<div class="cabinet-order__time">
						...
						<div class="cabinet-orders">
							<div class="cabinet-order">
								...
								<div class="cabinet-order__wrap">
									...
									<div>
										<div class="cabinet-order__time">
											<span class="green">Законченный</span>
											<!-- red green -->
											29.10.2021
										</div>
